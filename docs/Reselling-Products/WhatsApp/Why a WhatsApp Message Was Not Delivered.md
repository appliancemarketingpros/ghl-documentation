...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000004824-why-a-whatsapp-message-was-not-delivered](https://help.gohighlevel.com/support/solutions/articles/155000004824-why-a-whatsapp-message-was-not-delivered)  
...
Common reasons a message shows "sent" but not "delivered," and how to resolve each one
...
User Was Offline for More Than 30 Days
...
Outdated App Version or Terms Not Accepted
...
High-Quality Messaging Restrictions
...
Invalid or Unregistered Phone Number
...
Q1. Why was my WhatsApp message marked as sent but not delivered?
...
Q2. What does "Message Undeliverable" mean?
...
Q3. How can I check if the recipient blocked my number?
...
Q4. What is the 24-hour Customer Service Window?
...
Q5. What is the "High-Quality User Experience" error?
...
Q6. How can I resolve the "High-Quality User Experience" delivery issue?
...
Q7. How do I know if a user's WhatsApp version is outdated?
...
Q8. Can users in all countries receive WhatsApp Business messages?
...
Q9. What does it mean if I see both "delivered" and "failed" statuses for the same message?
...
Q10. What should I do if I get authentication or permission errors when sending messages?
