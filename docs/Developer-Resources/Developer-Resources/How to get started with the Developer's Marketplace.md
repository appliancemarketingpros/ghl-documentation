...
## **Glossary of terms:**
  ...
  * **Scopes:** Scopes define the specific permissions and access rights an app requires to interact with GoHighLevel. When creating an app, developers specify the necessary scopes that align with their app's functionalities. Scopes can include reading, writing, or managing permissions for different resources within GoHighLevel. [OAuth 2.0 Scopes](<https://oauth.net/2/scope/>) and this resource is for [_**Gohighlevel's OAuth Scopes.**_](<https://marketplace.gohighlevel.com/docs/Authorization/Scopes>)
...
For configuration details in Marketplace, see: <https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html>
...
Refer to the documentation [(](<https://highlevel.stoplight.io/docs/integrations/00d0c0ecaa369-get-access-token>)<https://marketplace.gohighlevel.com/docs/ghl/oauth/get-access-token>) for more details on how to obtain the access token.
