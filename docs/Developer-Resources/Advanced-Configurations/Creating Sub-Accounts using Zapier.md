...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/48001207048-creating-sub-accounts-using-zapier](https://help.gohighlevel.com/support/solutions/articles/48001207048-creating-sub-accounts-using-zapier)  
...
**Important Notes Before Proceeding Further:**
    ...
    The [Zapier LeadConnector integration](<https://zapier.com/apps/leadconnector/integrations>) action "**add Account** " was deprecated _**21st Feb. 2022**_**.**
    ...
    **For more information and links to our API documentation, visit our developer's website:********[https://developers.gohighlevel.com/](<https://developers.gohighlevel.com/>)**
    ...
    In order to use this article, Zapier webhooks are required which are not included in their free plan. Please sign up for a _**paid plan**_**** before proceeding further. 
...
**Please Note:**
    ...
    To use Zapier webhooks (premium) please sign up for a _**paid plan**_**.**
...
### **Step 3.4:** Next let's map the "**Data** " with the contact info submitted in _Step 2.2._
...
When adding a snapshot please add your "**Snapshot ID** " and the **"Type"** as either: _Own, Imported, Vertical_
 ...
 _What do the different_** __**_snapshot_** _"Types"_**_mean?_
...
### **Step 5.4:** Next let's map the User "**Data** " with the contact info submitted in _Step 2.2._
...
**Please Note:**
    ...
    Leave Password Field _Blank_ to **AUTO Generate a password**.   **_OR_**  Use 8 characters w/ special Symbols
