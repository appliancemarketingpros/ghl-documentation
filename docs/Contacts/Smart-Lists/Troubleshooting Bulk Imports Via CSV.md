...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/48001223155-troubleshooting-bulk-imports-via-csv](https://help.gohighlevel.com/support/solutions/articles/48001223155-troubleshooting-bulk-imports-via-csv)  
**Category:** Contacts  
**Folder:** Smart Lists
...
**Master Type  
**| ******Error ID**  
**(Optional)**| **Error code**| **What does the error means **| **Steps to resolve the error**  
---|---|---|---|---  
