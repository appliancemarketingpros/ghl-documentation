# WordPress: Payment Failure Notifications via Email & LC Plugin

**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000005792-wordpress-payment-failure-notifications-via-email-lc-plugin](https://help.gohighlevel.com/support/solutions/articles/155000005792-wordpress-payment-failure-notifications-via-email-lc-plugin)  
**Category:** Sites  
**Folder:** Wordpress
...
**TABLE OF CONTENTS**
  ...
  * Email Notification Timeline for Payment Failures
...
When a WordPress hosting payment fails, the system sends time-based email notifications with increasing urgency. If payment is not received after 21 days, the WordPress subscription is automatically canceled and the website is deleted.

  

    
    
    **Note** : This notification sequence is automated and does not require manual action by support.
...
**Day 1:** WordPress Payment Overdue ⏳

**Day 3:** Notice: Access Restricted ? 

**Day 7:** Final Reminder: Payment Needed for your WordPress Site Hosting ?

**Day 14:** Immediate Action Needed for your WordPress Site Hosting ⛔

**Day 21:** Your WordPress Subscription has been Canceled (subscription is canceled and the website is deleted) ❌
