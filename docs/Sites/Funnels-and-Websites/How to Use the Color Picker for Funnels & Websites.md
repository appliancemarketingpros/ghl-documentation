...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000005806-how-to-use-the-color-picker-for-funnels-websites](https://help.gohighlevel.com/support/solutions/articles/155000005806-how-to-use-the-color-picker-for-funnels-websites)  
**Category:** Sites  
...
The Color Picker allows you to choose and save colors in multiple formats so you can work with the values that best suit your needs. Use the dropdown to switch between color formats.  
  ...
  * **Custom Values** : Accepts dynamic tokens such as _{{ custom_values.primary_color }}._ These allow the color to be pulled from your custom values, making it easy to change in one place and have it update everywhere it is used.  
...
#### ** _Step 3:_**_Create Custom Color_
