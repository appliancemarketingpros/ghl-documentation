...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000005698-guide-funnel-website-stats-definitions](https://help.gohighlevel.com/support/solutions/articles/155000005698-guide-funnel-website-stats-definitions)  
**Category:** Sites  
...
---|---  
All  
| All page views - includes repeat visits.  
  
Unique  
| Unique visitors that visited the page.  
...
---|---  
All  
| Number of users who opted in for the product, bought the product, submitted a form/survey, or booked an appointment through a calendar.  
  
Rate  
| "All Opt-ins" divided by Unique Page Views.  
...
---|---  
Funnel Step Level  
| Number of sale orders that happened -> how many orders were placed (does not consider number of products or quantities purchased).  
  
Individual Product Level  
| Number of times the particular product has been purchased.  
  
Bump Product  
| Number of times the bump product is purchased.  
...
Uniques  
| Earnings divided by Unique Page Views. Total Sales Value ÷ Unique Page Views.  
