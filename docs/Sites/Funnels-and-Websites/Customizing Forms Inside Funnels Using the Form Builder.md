...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000005610-customizing-forms-inside-funnels-using-the-form-builder](https://help.gohighlevel.com/support/solutions/articles/155000005610-customizing-forms-inside-funnels-using-the-form-builder)  
**Category:** Sites  
...
**TABLE OF CONTENTS**
  ...
  * Localization in the Form Builder
...
Once the form builder opens in the pop-up, use the **Quick Add** and **Custom Fields** panels to configure your form:  
  ...
  * **Add Object Fields:** Add custom input types that match your lead capture strategy—ideal for gathering personalized or campaign-specific data.
...
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155071190220/original/8l7ZtA4TuKhgcy9s1GeB8aPJejb5dRaViQ.gif?1778637802)
...
HighLevel automatically adapts the Form Builder interface to match your account’s selected language. This ensures a consistent experience while editing forms inside the Funnel Builder.
...
Localization is controlled by your account’s language settings. When a language is selected, all supported UI text in the Form Builder updates automatically. No additional configuration is required.
...
This applies to the builder interface only, not to custom text added inside forms   
