...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000002178-track-chat-widget-activity-using-google-analytics-4-ga4-](https://help.gohighlevel.com/support/solutions/articles/155000002178-track-chat-widget-activity-using-google-analytics-4-ga4-)  
**Category:** Sites  
**Folder:** Chat Widget
...
**TABLE OF CONTENTS**
  ...
  * GA4 Tracking Events Captured by the Chat Widget
...
**Event Name**  
| **Trigger Condition**| **Category**| **Label**  
---|---|---|---  
widget-open| When the widget is opened| Live Chat**  
**| Widget Open**  
**  
widget-close  
|  When the widget is closed| Live Chat**  
**| Widget Close  
  
form-submit**  
**| When a chat form is submitted**  
**| Live Chat**  
**| Form Submitted  
