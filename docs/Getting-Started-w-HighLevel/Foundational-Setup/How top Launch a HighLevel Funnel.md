# How top Launch a HighLevel Funnel

**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000005057-how-top-launch-a-highlevel-funnel](https://help.gohighlevel.com/support/solutions/articles/155000005057-how-top-launch-a-highlevel-funnel)  
...
**TABLE OF CONTENTS**
  ...
  * Common Issues
    * 1\. My funnel isn't loading
    * 2\. My form isn't collecting leads
  * Related Articles
...
## **Prerequisites**
  ...
  * Access to a HighLevel sub-account  
  

  * A connected custom domain (or one ready to connect)  
  

  * A clear goal for your funnel (lead capture, appointments, sales, etc.)
...
Keep the existing steps but explain **when to choose each option**.
...
Option| Best For  
---|---  
Blank| Complete customization  
Template| Fastest setup  
Funnel AI| AI-assisted creation  
...
![](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155046286661/original/oaqTtT2iATnBeJzT1P4pgEkikblRY19hRA.png?1746659443)  
  ...
  2. Click **New Funnel** , then select one of these options:
     ...
     * **Funnel AI** (AI-powered creation)  
  

     * **From Templates** (use a pre-designed funnel)  
...
### **1\. My funnel isn't loading**
  ...
  * Confirm the funnel is assigned to the domain.
...
### **2\. My form isn't collecting leads**
  ...
  * Ensure a form is added to the page.  
  

  * Submit a test entry.  
  

  * Verify workflow or automation (if applicable).
...
## **Related Articles**
  ...
  * [](<https://help.gohighlevel.com/en/support/solutions/articles/155000004549>)[How to create a contact form in HighLevel?](<https://help.gohighlevel.com/en/support/solutions/articles/155000004549>)[](<https://help.gohighlevel.com/en/support/solutions/articles/155000004549>)
