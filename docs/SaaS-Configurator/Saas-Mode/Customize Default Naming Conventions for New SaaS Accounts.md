...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000005902-customize-default-naming-conventions-for-new-saas-accounts](https://help.gohighlevel.com/support/solutions/articles/155000005902-customize-default-naming-conventions-for-new-saas-accounts)  
...
## **How To Setup Default Naming Convention for New SaaS Subscribers**
  ...
  1. In your Agency view, Open **SaaS Configurator** → **Advanced Settings** → **Sub-Account** **Onboarding**.  
...
| **Company Name**| **Customer Name + ’s Account**  
---|---|---  
**Uses**|  Business name entered at checkout| Customer's personal name  
**Example**|  Acme Dental| Jane Smith’s Account  
**Best for**|  Agencies organizing accounts by business| Agencies organizing accounts by account owner  
**Fallback**|  Customer Name + ’s Account if Company Name is missing| Not applicable  
