...
Documents & Contracts Templates are reusable files with "fill in the blanks" sections which can even be filled automatically in workflows.
    ...
    NOTE: This article is about **__Templates__** , not individual Documents & Contracts. To view and edit **Templates** use the Payments > Documents & Contracts dropdown and select **Templates**. Make sure the title of the page includes **Templates** and you're on the **Templates** tab.  
