...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000003248-workflow-trigger-note-added](https://help.gohighlevel.com/support/solutions/articles/155000003248-workflow-trigger-note-added)  
**Category:** Workflows  
...
** _Scenario_ :** Support agents add notes describing unresolved issues. The workflow escalates the issue to a senior agent.
...
** _Outcome_ : **The workflow assigns the issue to a senior agent and sends an immediate notification for review.
...
** _Scenario_ :** After a networking event, notes added to attendee profiles should trigger personalized follow-up emails.
...
** _Outcome_ :** The workflow sends follow-up emails and updates attendee profiles with relevant tags.
...
** _Scenario_ : **Notes added to customer profiles about product preferences should trigger recommendations for related products.  
...
** _Outcome_ : **The workflow generates a personalized email recommending products based on their preferences.
