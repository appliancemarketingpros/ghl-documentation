...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000002674-workflow-trigger-custom-date-remimder](https://help.gohighlevel.com/support/solutions/articles/155000002674-workflow-trigger-custom-date-remimder)  
**Category:** Workflows  
...
The Custom Date Reminder Workflow Trigger starts a workflow before, on, or after a date field you select. The date fields you can select depend on the workflow type:

  


**Contact Based Workflows:** Contact date fields and supported Opportunity date fields.  
  


**Custom Object Based Workflows:** Date fields on the same custom object type the workflow is built around.

  
**Company Based Workflows:** Date fields on the Company object.

  


This trigger is useful for automating time-based follow-ups such as renewals, anniversaries, and expiry reminders.
...
When you add the Custom Date Reminder trigger, the date field selector only shows fields supported by that workflow type. This keeps the trigger aligned to the object the workflow runs on.
...
The Custom Date Field Filter lets you choose the date field the trigger evaluates. The available date fields depend on the workflow type:

  


  1. In contact-based workflows, you can select supported Contact date fields and supported Opportunity date fields.  
  

  2. In custom object–based workflows, you can select date fields from the same custom object type the workflow is built around.  
  

  3. In company-based workflows, you can select Company date fields.


  


The workflow starts when the reminder timing matches your settings (before, on, or after the selected date).
