...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/48001238249-guide-to-date-time-formatter-workflow-action](https://help.gohighlevel.com/support/solutions/articles/48001238249-guide-to-date-time-formatter-workflow-action)  
**Category:** Workflows  
...
Once the Date/Time Formatter action processes a date or time, it stores the reformatted value in a dynamic variable (e.g., {{datetime_formatter.1.date}}, {{datetime_formatter.1.datetime}}). You can reference this variable in subsequent workflow actions, such as sending emails, updating CRM fields, or triggering conditional logic based on the date value.
...
Yes, the Compare Dates function allows you to compare a stored contact date (e.g., “Signup Date” or “Last Purchase Date”) with the Current Date. This can be useful for triggering reminders, follow-ups, or automated actions when a certain number of days have passed. The difference in days will be stored in {{datetime_formatter.1.days}} for further use in workflows.
