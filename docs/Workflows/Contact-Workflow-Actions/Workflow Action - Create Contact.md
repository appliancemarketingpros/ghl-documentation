...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000002685-workflow-action-create-contact](https://help.gohighlevel.com/support/solutions/articles/155000002685-workflow-action-create-contact)  
**Category:** Workflows  
...
** _Scenario_ : **A business wants to capture customer information from web form submissions and create or update contact records automatically.
...
**_Outcome_ :** The workflow creates or updates contact records in the CRM and notifies the sales team for follow-ups.
...
** _Scenario_ :** When a customer makes a purchase, their CRM profile needs to be updated with transaction details.
...
**_Outcome_ : **The workflow updates the customer’s profile with their latest purchase and tags them as “Active Customer.”
...
** _Scenario_ :** Leads from a third-party platform are imported into the CRM, and their records need to be created or updated automatically.
...
**_Outcome_ :** The workflow ensures that all leads are accurately recorded in the CRM with relevant details, ready for follow-up.
...
** _Scenario_ : **A subscription-based business wants to create a contact record for each new customer and assign them to an onboarding specialist.
...
**_Outcome_ : **The workflow creates the contact record, assigns it to the onboarding team, and sends a welcome email.
...
** _Scenario_ : **Attendee information from event registration forms needs to be recorded in the CRM for tracking and communication.
...
**_Outcome_ : **The workflow creates contact records for all attendees and tags them with the event name for future engagement.
...
**Q. What triggers can we use with 'Create Contact' action?**

We recommend using it along with Inbound Webhook/Marketplace app Triggers.
