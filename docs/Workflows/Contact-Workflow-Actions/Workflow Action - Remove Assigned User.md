...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000003268-workflow-action-remove-assigned-user](https://help.gohighlevel.com/support/solutions/articles/155000003268-workflow-action-remove-assigned-user)  
**Category:** Workflows  
...
** _Scenario:_** A contact’s opportunity status changes to “Closed Won” or “Closed Lost.” The sales team no longer needs to follow up, and the contact should be reset for other workflows.  
...
** _Scenario:_**__ A support agent completes a task related to a contact, such as resolving a ticket. Once the task is done, the contact no longer requires direct assignment.  
