...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000004050-if-else-workflow-action-appointment-filter-options](https://help.gohighlevel.com/support/solutions/articles/155000004050-if-else-workflow-action-appointment-filter-options)  
**Category:** Workflows  
...
**TABLE OF CONTENTS**
  ...
  * What is the Appointment Option in If/Else Action?
...
_**Example Condition Names for different Appointment Filters:**_
...
When you select this filter, two dropdown menus appear to define the condition:
  ...
  * **_Second Dropdown:_ Time-Based Operators**
