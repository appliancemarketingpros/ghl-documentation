...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000005641-workflow-trigger-coupon-code-applied](https://help.gohighlevel.com/support/solutions/articles/155000005641-workflow-trigger-coupon-code-applied)  
**Category:** Workflows  
...
#### _**Step 1:****** Add the Trigger to Your Workflow_
...
####  _**Step 2:** Choose the Trigger Type_
...
#### _**Step 4:** Apply Filters to Target Specific Scenarios_
  ...
  * Each filter comes with specific operators (like _Is_ , _Contains_ , _Greater Than_ , _Before/After_) to precisely target the conditions you care about. Click Here to See List of Available Filters
...
####  _**Step 5:** Save and Build the Workflow_
...
Product Type| Contain Any / Is Empty / Is None Of / Is Not Empty  
| Multi-Select Dropdown of Product Types (One Time vs Recurring)  
Product(s) In Order| Contain Any / Is Empty / Is None Of / Is Not Empty  
| Multi-Select Dropdown of Products  
  
Source| Is / Is Empty / Is Not / Is Not Empty  
