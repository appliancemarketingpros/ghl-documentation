...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000004753-workflow-action-update-opportunity](https://help.gohighlevel.com/support/solutions/articles/155000004753-workflow-action-update-opportunity)  
**Category:** Workflows  
**Folder:** Opportunity Workflow Actions
...
This field lets you assign or update the monetary value of a deal in your pipeline. You can enter a fixed amount (like 500) or use a **custom value** based on the contact record or other workflow logic (for example, {{contact.quoted_price}}).
