...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000004751-workflow-action-find-opportunity](https://help.gohighlevel.com/support/solutions/articles/155000004751-workflow-action-find-opportunity)  
**Category:** Workflows  
...
**Scenario** : A new lead submits a form, and you want to check if an existing opportunity already exists for that lead. If it does, you update the opportunity; if not, you create a new one.
  ...
  2. **Action** : _Find Opportunity_
     ...
     * **Filters**(all conditions must be met):
       * **Opportunity Name** → **Contains** → “Contact_Email_Address”
       * **Status** → **Is** → “Open”
  3. **Branching** :
