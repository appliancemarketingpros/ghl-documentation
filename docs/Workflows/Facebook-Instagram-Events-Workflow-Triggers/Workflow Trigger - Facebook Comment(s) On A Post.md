...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000004645-workflow-trigger-facebook-comment-s-on-a-post](https://help.gohighlevel.com/support/solutions/articles/155000004645-workflow-trigger-facebook-comment-s-on-a-post)  
**Category:** Workflows  
...
**_Step 1: Select the Page._** Select Standard Fields > Page Is and then the page from the list.
...
**_Step 2: Select the post type._** Select Published Post to pick from a list or Custom Post to enter a URL.
...
** _Step 3: Identify the exact post._** If you used Published Post, then pick from the list, and if you used Custom Post, enter the direct URL.
