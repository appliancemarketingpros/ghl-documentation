...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000004661-workflow-action-facebook-interactive-messenger](https://help.gohighlevel.com/support/solutions/articles/155000004661-workflow-action-facebook-interactive-messenger)  
**Category:** Workflows  
...
The workflow action Facebook Interactive Messenger allows you to automate Messenger conversations and also include interactive elements like buttons and quick replies. Use this in combination with Facebook comment and/or message triggers.
    ...
    **Note** : The Facebook Interactive Messenger workflow action follows Meta’s 24-hour messaging policy. Outbound messages can only be delivered within 24 hours of a contact’s last interaction with your Facebook Page. If the contact does not interact again within that timeframe, the workflow message may not be delivered due to Facebook’s platform restrictions.
