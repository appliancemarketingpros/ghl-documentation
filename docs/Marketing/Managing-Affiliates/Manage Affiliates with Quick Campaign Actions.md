...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000004927-manage-affiliates-with-quick-campaign-actions](https://help.gohighlevel.com/support/solutions/articles/155000004927-manage-affiliates-with-quick-campaign-actions)  
**Category:** Marketing  
...
###  _**Step 1:** Click on Campaign Actions → Add to Campaign_
...
###  _**Step 2:** Choose the campaign from the pop-up list_
...
### ** _Step 1:_**_Select Campaign Actions → Remove from Campaign_
...
### ** _Step 2:_**_Pick the campaign from which you want to remove the affiliate_
...
### ** _Step 1:_**_Click Campaign Actions → Suspend Affiliate_
...
### ** _Step 2:_**_Choose the campaign you'd like to suspend them from._
...
### ** _Step 1:_**_From the Campaign Actions menu, choose “Move to Campaign.”_
...
### ** _Step 2:_**_Select the campaign where you want to move the affiliate._
...
### **_Step 3:_**_Decide what to do with existing customers_
...
### **_Step 4:_**_Choose whether to send the welcome email_
