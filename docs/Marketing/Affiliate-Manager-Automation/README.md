# Affiliate Manager Automation

**Category:** Marketing

## Articles

- [Workflow Trigger - Affiliate Enrolled In Campaign](Workflow Trigger - Affiliate Enrolled In Campaign.md)
- [Why Use Affiliate Automations?](Why Use Affiliate Automations.md)
- [Getting started with Affiliate Automations](Getting started with Affiliate Automations.md)
