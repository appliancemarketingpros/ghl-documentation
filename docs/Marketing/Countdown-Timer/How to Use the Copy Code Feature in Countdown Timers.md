...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000003103-how-to-use-the-copy-code-feature-in-countdown-timers](https://help.gohighlevel.com/support/solutions/articles/155000003103-how-to-use-the-copy-code-feature-in-countdown-timers)  
**Category:** Marketing  
...
Dynamic email in GHL (deadline relative to each contact) | Yes. Replace with the merge field {{right_now.date_time_iso}}. | Leave default {{contact.id}} OR swap for another contact field if you prefer. | GHL fills these merge tags at send‑time, giving every contact a personal clock.  
...
**_2\. Copy the Code for Website or Email_**
...
**_3\. Choose where to use and the Timer Alignment_**
...
**_4\. Enter Unique ID for Dynamic Timers (Optional)_**
...
**_5\. Replace with correct sender time  
_** The start date field is required when the timer is used in a code snippet block of a builder. 
