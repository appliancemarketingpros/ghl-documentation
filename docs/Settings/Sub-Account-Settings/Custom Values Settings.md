...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000004705-custom-values-settings](https://help.gohighlevel.com/support/solutions/articles/155000004705-custom-values-settings)  
**Category:** Settings  
...
** _Step 1:_**_Navigate to Custom Values_
...
**_Step 2:_**_Create Custom Value_
...
Fill in all of the relevant fields:  
  ...
  1. Name field. The Key part of the Custom Value will be created from the Name (ex: My Custom Value will be custom_values.my_custom_value).  
