...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000002371-integrating-outlook-with-highlevel-calendars](https://help.gohighlevel.com/support/solutions/articles/155000002371-integrating-outlook-with-highlevel-calendars)  
**Category:** Calendars & Appointments  
**Folder:** Calendar Integrations
...
###  _**Step 1:** Navigate to Calendar Connections_
...
### _**Step 2:** Authenticate with Outlook_
...
**Q: What if my Outlook calendar was deleted and HighLevel shows an error banner?**  
Click **Fix This** on the banner to review deleted calendar instances and where they’re connected in HighLevel. Then select **Remove Deleted Calendars** to remove broken connections and restore an error-free setup. 
