...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/48000982582-load-snapshots-into-existing-sub-account](https://help.gohighlevel.com/support/solutions/articles/48000982582-load-snapshots-into-existing-sub-account)  
...
### _**Step 1:** Navigate to "Manage Client"_
...
###  _**Step 2:** Select and Load Snapshot_
...
###  _**Step 4:** Select Assets_
  ...
  * Click the blue **Proceed** button when you are done  
    ...
    Note: If your snapshot includes Webinars, importing them clones the webinar pages and automatically creates the corresponding webinar sessions. Related webinar data is restored during the import.
...
#### **LinkedIn Ad Campaigns (Marketing Assets)**

  
If the snapshot contains LinkedIn campaigns, you can import them into the destination sub-account:

  
In the asset list, select Ad Campaigns – LinkedIn.

  
Continue to the conflict check step to review standard conflicts before importing.

  

    
    
    Imported LinkedIn campaigns are always created in Draft status.
    
    If LinkedIn is not connected in the destination sub-account, the import still completes and campaigns are created as Draft.
    
    Lead Gen Forms are not imported.
...
### _**Step 5:** Resolve Conflicts_
  ...
  * After reviewing, click the blue **Proceed** button  
    ...
    Note: Conflict resolution applies to Webinars the same way it applies to other asset types. Choose Override to replace the existing webinar asset, or Skip to keep the current version.
