...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000005476-how-to-reach-out-to-prospect-leads-generated-via-the-prospecting-tool](https://help.gohighlevel.com/support/solutions/articles/155000005476-how-to-reach-out-to-prospect-leads-generated-via-the-prospecting-tool)  
**Category:** Agency View  
**Folder:** Prospecting Tool
...
## **Engage from a Prospect Card (Prospecting dashboard)**

  


In Sub-Account Prospecting, use the Prospect Card **Lead Actions** icon to:

  


  * View contact details.
  * Open recent conversations (SMS, email, or calls) from the same screen.


  


In Agency Prospecting, these actions can prompt you to switch into a linked sub-account (or create one) before you continue interacting with the lead.
