...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000005327-ask-ai-assistant](https://help.gohighlevel.com/support/solutions/articles/155000005327-ask-ai-assistant)  
...
**TABLE OF CONTENTS**
  ...
  * 1\. Contacts & CRM
  * 2\. Marketing & Content
  * 3\. Funnels, Sites & Media
  * 4\. Calendars & Scheduling
  * 5\. Payments & Commerce
  * 6\. Courses & Memberships
  * 7\. AI & Automation
...
**Mobile availability:** Ask AI on the HighLevel, LeadConnector, and whitelabeled mobile apps is currently available to **Agency Admins**.
...
**Ad Campaign Management**| **Create, list, and review campaign performance across Google, Facebook, and LinkedIn ad platforms.**| **“Show me my top-performing Google campaigns.”****“Create a new Facebook lead generation campaign.”**  
...
| Find relevant Marketplace apps and integrations by describing a business need or use case in natural language.  
  
| "Is there an IDX integration for real estate available?"  
...
Sr| **Module**| **What Ask AI Can Do**  
---|---|---  
1| **Funnels**| **Fetch funnels and funnel pages, create and manage redirects**  
2| **Media Library**| **Upload, organize, trash, and delete files and folders; manage Google Drive as a media storage source**  
...
**Custom Fields**| **Create, update, and delete custom fields and folders using natural-language requests. Ask AI can identify custom fields by name, so you do not need to provide a Field ID. It supports custom fields for Contacts and Opportunities, as well as Custom Object fields.**  
...
**Marketplace**|  Discover relevant Marketplace apps from natural-language requests, retrieve installer details, manage wallet charges, and configure rebilling.  
...
The Ask AI sidebar helps users manage conversations from one place. Users can review previous sessions, return to an existing conversation, or start a new chat when they want to begin a separate task.
...
| “Find an IDX integration for real estate.” “Show me Marketplace apps for lead generation.”  
