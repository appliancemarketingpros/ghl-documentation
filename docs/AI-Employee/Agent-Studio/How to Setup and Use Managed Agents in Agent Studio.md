...
**Social Media Assistant** — Generates and publishes on-brand posts with images across multiple social platforms.
...
Test the Managed Agent in the built-in panel
  ...
  4. Iterate using chat-based editing until responses and actions look correct.
