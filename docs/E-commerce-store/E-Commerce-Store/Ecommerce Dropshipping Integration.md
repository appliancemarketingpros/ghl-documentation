...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000006224-ecommerce-dropshipping-integration](https://help.gohighlevel.com/support/solutions/articles/155000006224-ecommerce-dropshipping-integration)  
...
Use the Public API to first create a Product, then create one or more Prices for that product. For simple items, you will have a single price; for variant items, create a price per variant combination.
  ...
  * Price creation:
    ...
    * Create Price referencing the product _id: include locationId, type (one_time/recurring), currency, amount, sku, and optional inventory flags.
