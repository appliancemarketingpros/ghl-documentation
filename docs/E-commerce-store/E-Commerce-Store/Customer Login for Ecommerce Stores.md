...
Follow these steps to enable and customize Customer Login for your ecommerce store:
  ...
  5. Verify that your **store domain is added and verified**.
    ...
    **Important:** If the toggle is OFF, the login button will not appear in your store’s navigation. A valid domain must be connected and verified for the login feature to work.
...
The login button will not appear in your store’s navigation menu, and customers will not be able to log in.
...
Yes, you can add multiple menu items with redirect URLs and control how each opens (new tab or current tab).
...
Currently, the login provides access to past orders and logout functionality. CRM syncing is not enabled yet.
...
The login button will be non-functional, and the customer login feature will not work correctly.
