...
**Source URL:** [https://help.gohighlevel.com/support/solutions/articles/155000004051-how-to-add-customer-login-in-ecommerce-stores-to-view-order-details-and-past-orders-](https://help.gohighlevel.com/support/solutions/articles/155000004051-how-to-add-customer-login-in-ecommerce-stores-to-view-order-details-and-past-orders-)  
...
**Automatic verification:** OTP requests in the Customer Access Center are automatically protected by Cloudflare Turnstile. Verification normally happens in the background without requiring any action from the customer. If additional verification is required, a visible challenge appears before the customer can continue with the OTP request.No setup or configuration is required.  
